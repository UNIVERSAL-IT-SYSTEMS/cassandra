...
public class StorageProxy implements StorageProxyMBean
{
    ...
    public static final boolean OPTIMIZE_LOCAL_REQUESTS = true; // set to false to test messagingservice path on single node
    ...
    public static class LocalRangeSliceRunnable extends DroppableRunnable
    {
        ...
        public LocalRangeSliceRunnable(RangeSliceCommand command, ReadCallback<RangeSliceReply, Iterable<Row>> handler)
        {
            super(MessagingService.Verb.READ);
            this.command = command;
            this.handler = handler;
    ...
    public static List<InetAddress> getLiveSortedEndpoints(Table table, RingPosition pos)
    {
     ...
     */
    public static <T extends RingPosition> List<AbstractBounds<T>> getRestrictedRanges(final AbstractBounds<T> queryRange)
    {
